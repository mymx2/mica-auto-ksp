...
plugins {
  id("io.github.mymx2.build") version "1.5.4"
  id("io.github.mymx2.build.feature.catalogs") version "1.5.4"
  id("io.github.mymx2.plugin.dy.example.settings") version "1.5.4"
